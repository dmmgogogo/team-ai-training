...
> Anthropic 出品的终端编程助手，适合代码库级任务自动化
...
| 工具 | 优势场景 | 成本口径 | 数据隐私 |
|------|---------|----------|---------|
| **Cursor** | 日常团队开发、IDE 内协作 | 订阅制 | 企业版可配置 |
| **Windsurf** | 个人与小团队 agentic 开发 | 分层订阅 | 中等 |
| **Copilot** | JetBrains/VS Code 统一协作 | 订阅制 | 企业版成熟 |
| **Claude Code** | 代码库级任务、终端自动化 | API 计费 | 高 |
| **Codex CLI** | 终端代理、复杂任务拆解 | API 计费 | 高 |
| **Gemini CLI** | 开源 CLI 试用与自动化 | 低门槛 | 高 |
| **Aider** | 多模型切换、本地模型接入 | 开源+模型费 | 高 |
| **Antigravity** | 新兴工作流探索 | 视版本计划 | 待观察 |
| **Kimi Code** | 国内合规与本地化需求 | 视部署方式 | 高 |
| **v0** | 前端原型与组件生成 | 按平台计划 | 中等 |
