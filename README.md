...
>
> 🕐 最近更新：2026-05-01 — M11 新增《Claude Code 省 Token 指南》图文整理（含封面图与实战要点）；并入 Superpowers 与 gstack 提效资料；完成深度更新与每 3 天自动文档巡检机制
...
- 已启用自动巡检：`.github/workflows/docs-auto-refresh.yml`
- 默认每 **3 天**执行一次（UTC 时间）
- 巡检脚本：`scripts/refresh_docs.py`
- 维护规则说明：`MAINTENANCE.md`
